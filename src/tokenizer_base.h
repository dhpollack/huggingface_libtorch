...
class TokenizerBase {
public:
  TokenizerBase(string bos_token, string eos_token, string unk_token,
                string sep_token, string pad_token, string cls_token,
                string mask_token, vector<string> additional_special_tokens,
  ...
  virtual tpenc encode(string &text_a, string &text_b, bool add_special_tokens,
...
protected:
  ...
  const string bos_token;
  const string eos_token;
  const string unk_token;
  const string sep_token;
  const string pad_token;
  const string cls_token;
  const string mask_token;
  const vector<string> additional_special_tokens;
