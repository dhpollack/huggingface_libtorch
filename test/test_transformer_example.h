...
TEST(transformerexampleTest, create_transformer_example) {
  string text_a("this is a test sentence without a second text");
  string text_b("this is text_b");
  InputExample ex1 = {"example1", text_a, "", "0"};
  EXPECT_EQ(ex1.text_a, text_a);
  InputExample ex2 = {"example2", text_a, text_b, "0"};
